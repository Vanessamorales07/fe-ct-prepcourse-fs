...
//    // agregamos con push para cada posicion [i] sumamos 1
...
function cuentoElementos(array) {
   ...
   // Tu código:
var recuentoElementos = 0
for (var i =0; i< array.length; i ++){
   if (array[i] > 18) {
   recuentoElementos =recuentoElementos + 1; 
}} return recuentoElementos;
}
